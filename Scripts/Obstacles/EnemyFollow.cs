...
public class EnemyFollow : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Patrol(); // Se o jogador não estiver atribuído, patrulha normalmente
        }
    }
    ...
    public void TakeDamage(int damage)
    {
        ...
        // Chama a coroutine para voltar a cor ao normal depois de 1 segundo (ajuste o tempo conforme necessário)
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Player"))
        {
            ...
            // Verifica se a colisão ocorreu pela parte superior do inimigo
            if (contact.normal.y < 0)  // Se a normal da colisão estiver apontando para baixo (parte de cima do inimigo)
            {
                // O jogador está colidindo com a parte superior do inimigo, mata o inimigo
                Die();
            }
            else
            {
    ...
    private void FollowPlayer()
    {
        ...
        // Gira o sprite dependendo da direção do movimento
    ...
    private void Patrol()
    {
        // Código de patrulha já existente
    }
}